...
SESSION_CONFIGS = [dict(name='experiment', num_demo_participants=2,
	initial_mean_energy_level=105, initial_std_energy_level = 5,number_mock_rounds=1, 
	steal_success_prob = 1/3,victims_payoff=10,energy_stochasticity=3,energy_cost=0,
	cooperation_payoff=5,penalty=10,threshold=100,lone_payoff=0,steal_failure_payoff=-40,steal_success_payoff=20,
